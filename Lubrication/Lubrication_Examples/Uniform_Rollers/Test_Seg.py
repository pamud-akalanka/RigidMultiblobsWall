...
sys.path.append('./home/pamud/github/RigidMultiblobsWall/Lubrication/Lub_Solver.py')
sys.path.append('./home/pamud/github/RigidMultiblobsWall/')
...
#import os
#os.path.abspath("/home/pamud/github/RigidMultiblobsWall/Lubrication/Lub_Solver.py")
